...
#
# Some example calls:
# ./zap-vs-vulnerableApp.sh -d "ghcr.io/zaproxy/zaproxy:weekly" -e "66" -n "vulnerableApp-weekly-RB-M-M" -t "Rel,Beta"
# ./zap-vs-vulnerableApp.sh -d "ghcr.io/zaproxy/zaproxy:weekly" -e "66" -p "St-High-Th-Med" -n "vulnerableApp-weekly-RB-H-M" -t "Rel,Beta"
# ./zap-vs-vulnerableApp.sh -d "ghcr.io/zaproxy/zaproxy:weekly" -e "66" -n "vulnerableApp-weekly-RBA-M-M" -t "Rel,Beta,Alpha" -z "-addoninstall ascanrulesAlpha"
