...
./raise-issue.py -t "Issue name" -f file -a zapbot -p changeme
...
def get_args():
    ...
    parser.add_argument('-o', '--owner',
			default='zapbot',
                        help='Repo owner, e.g. zapbot')

    parser.add_argument('-r', '--repo',
			default='zap-mgmt-scripts',
                        help='Repo, e.g. zap-mgmt-scripts')
...
def main():
    ...
    make_github_issue(cli_args['title'], cli_args['owner'], cli_args['repo'], cli_args['user'], 
